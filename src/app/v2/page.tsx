...
ਤੱਤ ਸੱਤ ਸਉਦਾ ਕੋਈ ਵਣਜਦਾ ਨਾ, ਹੋਇਆ ਵਣਜੁ ਪਰਧਾਨੁ ਦਮੜੋਲਿਆਂ ਦਾ।"`}</p>
            ...
            >
                ...
                <div className="relative bg-[#fdf7ee]/97 border border-[#e8d5b4] shadow-2xl rounded-[2.5rem] w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="md:w-3/5 p-8 md:p-10 overflow-y-auto max-h-[90vh] custom-scrollbar">
                        <h3 className="font-display text-3xl text-[#1f130f] mb-1">
                            Words from Jathedar Ji
                        </h3>
                        <p className="text-[#a06a29] text-xs font-bold uppercase tracking-[0.22em] mb-8">
                            ਸਿਮਰਨਜੀਤ ਸਿੰਘ
                        </p>
                        <div className="text-[#4a3427]/90 leading-relaxed space-y-5 text-sm">
                            <p className="text-[#a06a29] font-bold italic text-base border-l-4 border-[#f29b38] pl-4 bg-[#f29b38]/6 py-2">
                                ਧੰਨੁਸੁਕਾਗਦੁਕਲਮਧੰਨੁਧਨੁਭਾਂਡਾਧਨੁਮਸੁ॥
                                <br />
                                ਧਨੁਲੇਖਾਰੀਨਾਨਕਾਜਿਨਿਨਾਮੁਲਿਖਾਇਆਸਚੁ॥੧॥
                            </p>
                            <p>
                                ...
                                ਸਿੱਧੇ ਰਾਹ ਪਾਇਆ ਤੇ ਉਹਨਾਂ ਨੂੰ ਸਬਦ ਦੇ ਲੜ ਲਾਇਆ।
                            </p>
                            <p>
                            ...
                            <div className="pt-4 border-t border-[#e8d5b4]">
                                <p className="font-bold text-[#1f130f]">
                                    ਨੀਚਾ ਅੰਦਰਿ ਨੀਚ ਜਾਤਿ ਨੀਚੀ ਹੂ ਅਤਿ ਨੀਚ
                                </p>
                                <p className="text-[#a06a29] font-semibold text-xs mt-1">
                                    ਗੁਰੂ ਗ੍ਰੰਥ ਜੀ ਗੁਰੂ ਪੰਥ ਜੀ ਅਤੇ ਸਾਧਸੰਗਤਿ ਦਾ ਗੋਲਾ
                                </p>
                                <p className="text-[#3E2723] mt-2 font-medium">ਸਿਮਰਨਜੀਤ ਸਿੰਘ</p>
                            </div>
                        </div>
                    </div>
                </div>
